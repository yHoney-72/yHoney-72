<div align="center">
<img src="https://capsule-render.vercel.app/api?type=blur&height=280&color=gradient&text=Honey%20Chauhan&fontColor=ffffff&textBg=false&fontSize=55&animation=fadeIn" width="100%"/>
...
![JDBC](https://img.shields.io/badge/JDBC-005F87?style=for-the-badge&logo=oracle&logoColor=white)
...
![Resilience4j](https://img.shields.io/badge/Resilience4j-009688?style=for-the-badge&logoColor=white)
...
### 🛒 **FlashCart ELITE**
<sub><b>Production-Grade Quick Commerce Backend</b></sub>

10-minute delivery backend built with a production-first mindset — modular monolith architecture, event-driven design, and resilient APIs.

**Tech:**  
`Spring Boot` `PostgreSQL` `Redis` `Kafka` `Resilience4j` `Docker` `JWT`

[![Repository](https://img.shields.io/badge/View_Repository-181717?style=for-the-badge&logo=github)](https://github.com/yHoney-72/flashcart-backend)
...
### 🛡️ **SentinelX**
<sub><b>Backend Moderation & Rate Limiting Platform</b></sub>

Content moderation system with Redis-based concurrency control, virality scoring engine, and scheduled moderation workflows.

**Tech:**  
`Spring Boot` `PostgreSQL` `Redis` `Docker`

[![Repository](https://img.shields.io/badge/View_Repository-181717?style=for-the-badge&logo=github)](https://github.com/yHoney-72/SentinelX)
